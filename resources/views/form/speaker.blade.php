            ...
            <div class="container">
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-md-6" v-if="show">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-center">講者資料上傳表單</h3>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-10" id="sponsorForm" v-if="!show">
                        <h2 class="d-inline-block my-3">講者表單</h2>
                        <h4 class="d-inline-block mx-2">Speaker form</h4>
                        <form id="sendform" class="needs-validation" novalidate>
                            <h4 class="text-primary mt-2">個人資料</h4>
                            <hr>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="company_e">英文公司/組織</label>
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between flex-column flex-md-row">
                                    <label for="introduction_e">個人介紹 (英文)</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback">請上傳照片</div>
                            </div>
                            ...
                            <h4 class="text-primary mt-4">議程資料</h4>
                            <hr>
                            <div class="form-group">
                                <div class="d-flex justify-content-between flex-column flex-md-row">
                                    <label for="topic">演講主題*</label>
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between flex-column flex-md-row">
                                    <label for="topic_e">演講主題 英文 ( 若無提供，將由我們工作人員協助翻譯 )</label>
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between flex-column flex-md-row">
                                    <label for="summary_e">演講主題 英文 ( 若無提供，將由我們工作人員協助翻譯 )</label>
                            ...
                            <div class="form-group">
                                ...
                                <br><small class="form-group-check__text mt-5">若無適用的標籤，請告知我們工作人員。</small>
                            </div>
                            <div class="form-group">
                                <p class="mb-1">難易度</p>
                            ...
                            <h4 class="text-primary mt-4">行政資訊</h4>
                            <hr>
                            <div class="form-group">
                                <p class="mb-1">T-shirt 尺寸</p>
