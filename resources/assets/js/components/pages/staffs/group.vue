                                        ...
                                        <tr v-for="item in list">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary"
                                                        v-on:click="openEditgroup(item.id, 'edit')">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="dataTables_paginate paging_simple_numbers" id="group_paginate">
                                        <ul class="pagination">
                                            <li class="paginate_button previous" id="group_previous"
                                                v-bind:class="[page_info.current_page-1 == 0 ? 'disabled' : '']">
                                                <a aria-controls="group" data-dt-idx="0" tabindex="0"
                                            ...
                                            <li v-for="i in getPageArray" class="paginate_button"
                                                ...
                                                <a aria-controls="group" data-dt-idx="1" tabindex="0"
                                                   v-on:click="changePage(i)">{{ i }}</a>
                                            </li>
                                            <li class="paginate_button next" id="group_next"
                                                v-bind:class="[page_info.current_page+1 > page_info.last_page ? 'disabled' : '']">
                                                <a aria-controls="group" data-dt-idx="7" tabindex="0"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button v-if="action == 'new'" type="button" class="btn btn-primary"
                                                v-on:click="createNewgroup()">Create
                                        </button>
                                        <button v-if="action == 'edit'" type="button" class="btn btn-primary"
                                                v-on:click="savegroup(add_group.id)">Save
                                        </button>
                                    </div>
                                </div>
                            </div>
