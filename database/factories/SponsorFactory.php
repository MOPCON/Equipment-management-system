...
$factory->define(App\Sponsor::class, function () {
    ...
    return [
        ...
        'en_introduction'               => $enFaker->text(250),
        'website'                       => $enFaker->url,
        ...
        'promotion_app_push_image_link' => $enFaker->imageUrl(120, 120, 'cats'),
        'promotion_app_push_title'      => $zhFaker->text(120),
        'promotion_app_push_content'    => $zhFaker->text(120),
        'promotion_app_push_link'       => $enFaker->url,
