...
class SponsorRequest extends BaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'logo_path'                    => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar|max:20000',
            'cloud_logo_path'              => 'nullable|url',
            'service_photo_path'           => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar|max:20000',
            'cloud_service_photo_path'     => 'nullable|url',
            'promote'                      => 'nullable|string',
            'slide_path'                   => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar|max:20000',
            'cloud_service_photo_path'     => 'nullable|url',
            'board_path'                   => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar|max:20000',
            ...
            'advence_icck_ad_path'               => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar|max:20000',
            'cloud_advence_icck_ad_path'         => 'nullable|url',
            'advence_registration_ad_path'       => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar|max:20000',
            'cloud_advence_registration_ad_path' => 'nullable|url',
            'advence_keynote'                    => 'nullable|string',
            'advence_hall_flag_path'             => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar|max:20000',
            'cloud_advance_hall_flag_path'       => 'nullable|url',
            'advence_main_flow_flag_path'        => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar|max:20000',
