...
class SponsorController extends Controller
{
    ...
    private static $FieldsForTSV = [
        ...
        'promotion_gather_town_h_link'  => 'Gather Town 橫式圖片',
        'promotion_gather_town_v_link'  => 'Gather Town 直式圖片',
        'promotion_gather_town_video_link' => 'Gather Town 宣傳影片',
        'promotion_app_push_image_link' => '大會 App 推播訊息圖片',
        'promotion_app_push_title'      => '大會 App 推播訊息標題',
        'promotion_app_push_content'    => '大會 App 推播訊息內文',
        'promotion_app_push_link'       => '大會 App 推播訊息跳轉連結',
