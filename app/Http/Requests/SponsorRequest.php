...
class SponsorRequest extends BaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'logo_path'                    => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar',
            'service_photo_path'           => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar',
            'promote'                      => 'nullable|string',
            'slide_path'                   => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar',
            'board_path'                   => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar',
            ...
            'advence_icck_ad_path'         => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar',
            'advence_registration_ad_path' => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar',
            'advence_keynote'              => 'nullable|string',
            'advence_hall_flag_path'       => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar',
            'advence_main_flow_flag_path'  => 'nullable|mimes:jpeg,png,gif,bmp,svg,pdf,ai,eps,psd,zip,rar',
