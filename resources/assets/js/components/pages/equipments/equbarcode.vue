                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="dataTables_paginate paging_simple_numbers" id="equ_barcode_paginate">
                                        <ul class="pagination">
                                            <li class="paginate_button previous" id="equ_barcode_previous"
                                                v-bind:class="[page_info.current_page-1 == 0 ? 'disabled' : '']">
                                                <a aria-controls="equ_barcode" data-dt-idx="0" tabindex="0"
                                            ...
                                            <li v-for="i in getPageArray" class="paginate_button"
                                                ...
                                                <a aria-controls="equ_barcode" data-dt-idx="1" tabindex="0"
                                                   v-on:click="changePage(i)">{{ i }}</a>
                                            </li>
                                            <li class="paginate_button next" id="equ_barcode_next"
                                                v-bind:class="[page_info.current_page+1 > page_info.last_page ? 'disabled' : '']">
                                                <a aria-controls="equ_barcode" data-dt-idx="7" tabindex="0"
