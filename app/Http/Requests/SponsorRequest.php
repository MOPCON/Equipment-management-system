...
class SponsorRequest extends BaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'sponsor_type'                 => 'nullable|integer|min:0|max:' . count(Sponsor::$sponsorTypeItem[2022]),
            ...
            'promotion_app_push_image_link'      => 'nullable|url',
            'promotion_app_push_title'           => 'nullable|string',
            'promotion_app_push_content'         => 'nullable|string',
            'promotion_app_push_link'            => 'nullable|url',
    ...
    public function attributes()
    {
        $attrs = [
            ...
            'promotion_app_push_image_link' => __('sponsor.advance.app_push'),
            'promotion_app_push_title'      => __('sponsor.advance.app_push_title'),
            'promotion_app_push_content'    => __('sponsor.advance.app_push_content'),
            'promotion_app_push_link'       => __('sponsor.advance.app_push_link'),
            'note'                          => '後台備註',
            'updated_by'                    => '最後更新者',
        ];
